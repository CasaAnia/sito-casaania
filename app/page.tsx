  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative text-white pt-40 pb-12 px-4 overflow-hidden" style={{ minHeight: '420px', maxHeight: '560px' }}>
        <img src="/hero-mobile.jpg" alt="Vista Humanitas dal balcone" className="absolute inset-0 w-full h-full object-cover md:hidden" style={{ objectPosition: 'center 45%', transform: 'scale(1.1)', transformOrigin: 'center center' }} />
