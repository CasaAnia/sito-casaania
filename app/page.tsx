    ...
    <main className="min-h-screen text-gray-900" style={{backgroundColor: '#f9f6f1'}}>
      ...
      <section className="pt-16 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p style={loraStyle} className="text-center text-gray-500 text-base uppercase tracking-widest mb-6 px-4">Le nostre camere</p>
              ...
              <div key={i} className="overflow-hidden">
                ...
                <div className="px-4 pt-4 pb-2">
                  <div className="flex items-start justify-between mb-1">
                    <h3 style={loraStyle} className="font-semibold text-gray-800 uppercase tracking-widest">{room.name}</h3>
                    {room.badge && (
