    ...
    <main className="min-h-screen text-gray-900" style={{ backgroundColor: '#f9f6f1' }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="border-t border-gray-200 pt-4 mb-8 grid grid-cols-2 gap-x-4">
          ...
          <p className="text-2xl font-semibold text-gray-800 mt-1">€70 <span className="text-sm font-normal text-gray-700">/ notte</span></p>
          <p className="text-2xl font-semibold text-gray-800 mt-1">€75 <span className="text-sm font-normal text-gray-700">/ notte</span></p>
        </div>
