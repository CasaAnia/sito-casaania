...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h2
      style={{ ...loraStyle, textUnderlineOffset: '6px' }}
      className="text-gray-500 text-lg uppercase tracking-widest mb-4 underline"
    >
      {children}
    </h2>
  )
    ...
    <main className="min-h-screen text-gray-900" style={{ backgroundColor: '#f9f6f1' }}>
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-1 text-gray-400 hover:text-gray-600 text-sm" style={loraStyle}>
            ← Indietro
          </Link>
          <a
            href={WA_LINK}
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <h1 style={loraStyle} className="text-3xl font-semibold text-gray-800 mb-4 leading-snug">
          Come arrivare all&apos;ospedale Humanitas da Casa Ania
        </h1>

        <p style={loraStyle} className="text-gray-600 leading-relaxed mb-3">
        ...
        <p style={loraStyle} className="text-gray-600 leading-relaxed mb-6">
        ...
        <div className="bg-white rounded-2xl p-5 mb-10">
          <p style={loraStyle} className="text-sm text-gray-700 mb-1">
            📍 <strong>Casa Ania</strong> — Via Liguria 26, Fizzonasco, Pieve Emanuele (MI) 20072
          </p>
          <p style={loraStyle} className="text-sm text-gray-700 mb-3">
        ...
        <section className="mb-10">
          ...
          <p style={loraStyle} className="text-gray-600 leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <ul style={loraStyle} className="text-gray-600 leading-relaxed space-y-2 list-disc pl-5 mb-4">
            <li>
        ...
        <section className="mb-10">
          ...
          <a
            ...
            rel="noopener noreferrer"
            style={loraStyle}
            className="inline-block bg-green-700 text-white font-bold px-6 py-3 rounded-full text-sm"
          >
        ...
        <section className="mb-10">
          ...
          <ul style={loraStyle} className="text-gray-600 leading-relaxed space-y-2 list-disc pl-5">
            <li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-5">
            {faqs.map(({ q, a }) => (
              <div key={q}>
                <h3 style={loraStyle} className="font-semibold text-gray-800 mb-1">
                  {q}
                </h3>
                <p style={loraStyle} className="text-gray-600 leading-relaxed">
                  {a}
        ...
        <div className="rounded-2xl p-6 text-center bg-white">
          <p style={{ ...loraStyle, color: '#007f5b' }} className="text-lg font-semibold uppercase tracking-widest mb-2">
            Prenota il tuo soggiorno vicino a Humanitas
          </p>
          <p style={loraStyle} className="text-sm text-gray-500 mb-5">
